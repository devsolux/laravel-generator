...
namespace DevSolux\Generator\Generators;
...
class ModelGenerator extends BaseGenerator
{
    ...
    public function generate()
    {
        ...
        $this->config->commandComment(app_nl().'Model created: ');
    ...
    {
        return [
            'fillables'        => implode(','.app_nl_tab(1, 2), $this->generateFillables()),
            'casts'            => implode(','.app_nl_tab(1, 2), $this->generateCasts()),
            'rules'            => implode(','.app_nl_tab(1, 2), $this->generateRules()),
    ...
    public function generateSwagger(): string
    {
        ...
        return view('swagger-generator::model.model', [
            ...
            'properties'     => implode(','.app_nl().' ', $properties),
        ]);
    }
    ...
    protected function generateRelations(): string
    {
        ...
        return implode(app_nl_tab(2), $relations);
    }
