...
use DevSolux\Generator\Generators\ViewServiceProviderGenerator;
use DevSolux\Generator\Utils\HTMLFieldGenerator;
...
//        }
        ...
        $this->config->commandComment(app_nl().'Generating Views...');
    ...
    protected function generateBladeTableBody(): string
    {
        ...
        $tableBodyFields = implode(app_nl_tab(1, 5), $tableBodyFields);
    ...
    protected function generateTableHeaderFields(): string
    {
        ...
        return implode(app_nl_tab(1, 4), $headerFields);
    }
...
//            }
        ...
        g_filesystem()->createFile($this->path.'fields.blade.php', implode(app_nls(2), $htmlFields));
