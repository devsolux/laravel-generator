...
namespace DevSolux\Generator\Commands\Publish;
...
class PublishUserCommand extends PublishBaseCommand
{
     ...
     * @var string
     */
    protected $name = 'devsolux.publish:user';
    ...
    private function copyViews()
    {
        ...
        $templateType = config('laravel_generator.templates', 'laravel-adminlte');
    ...
    private function updateRoutes()
    {
        ...
        $routeContents .= app_nls(2)."Route::resource('users', '$controllerNamespace\UserController')->middleware('auth');";
    ...
    private function updateMenu()
    {
        ...
        $menuContents .= app_nl().$usersMenuContent;
