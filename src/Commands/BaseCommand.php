...
use DevSolux\Generator\Common\GeneratorField;
use DevSolux\Generator\Common\GeneratorFieldRelation;
use DevSolux\Generator\Events\GeneratorFileCreated;
use DevSolux\Generator\Events\GeneratorFileCreating;
use DevSolux\Generator\Events\GeneratorFileDeleted;
use DevSolux\Generator\Events\GeneratorFileDeleting;
use DevSolux\Generator\Generators\API\APIControllerGenerator;
use DevSolux\Generator\Generators\API\APIRequestGenerator;
use DevSolux\Generator\Generators\API\APIResourceGenerator;
...
use DevSolux\Generator\Utils\GeneratorFieldsInputUtil;
use DevSolux\Generator\Utils\TableFieldsGenerator;
        ...
        if ($runMigration) {
            if ($this->option('forceMigrate')) {
                ...
                if ($this->option('jsonFromGUI') && $requestFromConsole) {
                    $this->runMigration();
                } elseif ($requestFromConsole && $this->confirm(app_nl().'Do you want to migrate database? [y|N]', false)) {
                    $this->runMigration();
                }
            }
        }
